      ...
      trailing: IconButton(
        ...
        onPressed: _loading
            ...
            : () async {
                ...
                try {
                  if (_localAdded) {
                    await ContactApi.removeUserAsFriend(ClientHolder.of(context).apiClient, user: widget.user);
                  } else {
                    await ContactApi.addUserAsFriend(ClientHolder.of(context).apiClient, user: widget.user);
                  }
                  setState(() {
                    _loading = false;
