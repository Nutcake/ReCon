...
class UpdateNotifier extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text("Update Available", style: Theme.of(context).textTheme.titleLarge),
      content: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text("Your version: $localVersion"),
            ],
          ),
          Row(
            children: [
          ...
          Row(
            ...
            children: [
              TextButton.icon(
                onPressed: () {
                  launchUrl(
                    Uri.parse("https://github.com/Nutcake/ReCon/releases/latest"),
